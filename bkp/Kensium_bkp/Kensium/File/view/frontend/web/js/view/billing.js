define([
    ...
    'Kensium_File/js/model/billing-address/form-popup-state',
    'Kensium_File/js/action/edit-billing-address',
    ...
    return Component.extend({
        defaults: {
            template: 'Kensium_File/billing',
            billingFormTemplate: 'Kensium_File/billing-address/form'
        },
